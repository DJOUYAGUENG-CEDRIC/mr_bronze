...
export default function PlatformsCard() {
  ...
  return (
    <div className="px-3 pt-3 pb-1">
      ...
      >
        <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: '#78350f' }}>
              ...
              {p.code && (
                <>
                  ...
                  <button
                    ...
                    style={{ color: copiedName === p.name ? '#16a34a' : '#b45309' }}
        ...
        {WHATSAPP_URL && (
          <div className="flex items-center gap-2 pt-2" style={{ borderTop: '1px solid #fde68a' }}>
